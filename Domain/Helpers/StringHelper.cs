...
public static class StringHelper
{
    ...
    public static string ImageFileName(IFormFile file, string userName)
    {
        ...
        {
            stringName = userName + "_" + VietNameseDateTimeNowToString() + "_" + UniqueString() + ".png";
        }
        else if (file.FileName.EndsWith(".jpg") || file.FileName.EndsWith(".JPG"))
        {
            stringName = userName + "_" + VietNameseDateTimeNowToString() + "_" + UniqueString() + ".jpg";
        }
        ...
        {
            stringName = userName + "_" + VietNameseDateTimeNowToString() + "_" + UniqueString() + ".gif";
        }
        else if (file.FileName.EndsWith(".webp") || file.FileName.EndsWith(".WEBP"))
        {
            stringName = userName + "_" + VietNameseDateTimeNowToString() + "_" + UniqueString() + ".webp";
        }
        else
        {
            stringName = userName + "_" + VietNameseDateTimeNowToString() + "_" + UniqueString() + ".jpg";
