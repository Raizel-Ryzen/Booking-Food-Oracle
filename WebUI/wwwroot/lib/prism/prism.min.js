...
Prism.languages.apl = {
    ...
    'number': /Â¯?(?:\d*\.?\b\d+(?:e[+Â¯]?\d+)?|Â¯|âˆž)(?:jÂ¯?(?:(?:\d+(?:\.\d+)?|\.\d+)(?:e[+Â¯]?\d+)?|Â¯|âˆž))?/i,
...
Prism.languages.bsl = {
    ...
    'keyword': [
        {
            // RU
            pattern: /(^|[^\w\u0400-\u0484\u0487-\u052f\u1c80-\u1c88\u1d2b\u1d78\u2de0-\u2dff\ua640-\ua69f\ufe2e\ufe2f])(?:Ð¿Ð¾ÐºÐ°|Ð´Ð»Ñ|Ð½Ð¾Ð²Ñ‹Ð¹|Ð¿Ñ€ÐµÑ€Ð²Ð°Ñ‚ÑŒ|Ð¿Ð¾Ð¿Ñ‹Ñ‚ÐºÐ°|Ð¸ÑÐºÐ»ÑŽÑ‡ÐµÐ½Ð¸Ðµ|Ð²Ñ‹Ð·Ð²Ð°Ñ‚ÑŒÐ¸ÑÐºÐ»ÑŽÑ‡ÐµÐ½Ð¸Ðµ|Ð¸Ð½Ð°Ñ‡Ðµ|ÐºÐ¾Ð½ÐµÑ†Ð¿Ð¾Ð¿Ñ‹Ñ‚ÐºÐ¸|Ð½ÐµÐ¾Ð¿Ñ€ÐµÐ´ÐµÐ»ÐµÐ½Ð¾|Ñ„ÑƒÐ½ÐºÑ†Ð¸Ñ|Ð¿ÐµÑ€ÐµÐ¼|Ð²Ð¾Ð·Ð²Ñ€Ð°Ñ‚|ÐºÐ¾Ð½ÐµÑ†Ñ„ÑƒÐ½ÐºÑ†Ð¸Ð¸|ÐµÑÐ»Ð¸|Ð¸Ð½Ð°Ñ‡ÐµÐµÑÐ»Ð¸|Ð¿Ñ€Ð¾Ñ†ÐµÐ´ÑƒÑ€Ð°|ÐºÐ¾Ð½ÐµÑ†Ð¿Ñ€Ð¾Ñ†ÐµÐ´ÑƒÑ€Ñ‹|Ñ‚Ð¾Ð³Ð´Ð°|Ð·Ð½Ð°Ñ‡|ÑÐºÑÐ¿Ð¾Ñ€Ñ‚|ÐºÐ¾Ð½ÐµÑ†ÐµÑÐ»Ð¸|Ð¸Ð·|ÐºÐ°Ð¶Ð´Ð¾Ð³Ð¾|Ð¸ÑÑ‚Ð¸Ð½Ð°|Ð»Ð¾Ð¶ÑŒ|Ð¿Ð¾|Ñ†Ð¸ÐºÐ»|ÐºÐ¾Ð½ÐµÑ†Ñ†Ð¸ÐºÐ»Ð°|Ð²Ñ‹Ð¿Ð¾Ð»Ð½Ð¸Ñ‚ÑŒ)(?![\w\u0400-\u0484\u0487-\u052f\u1c80-\u1c88\u1d2b\u1d78\u2de0-\u2dff\ua640-\ua69f\ufe2e\ufe2f])/i,
            lookbehind: true
        },
        {
            // EN
    ...
    'operator': [
        ...
        // RU
        {
            pattern: /(^|[^\w\u0400-\u0484\u0487-\u052f\u1c80-\u1c88\u1d2b\u1d78\u2de0-\u2dff\ua640-\ua69f\ufe2e\ufe2f])(?:Ð¸|Ð¸Ð»Ð¸|Ð½Ðµ)(?![\w\u0400-\u0484\u0487-\u052f\u1c80-\u1c88\u1d2b\u1d78\u2de0-\u2dff\ua640-\ua69f\ufe2e\ufe2f])/i,
            lookbehind: true
        },
        // EN
        {
    ...
    'punctuation': /\(\.|\.\)|[()\[\]:;,.]/,
    'directive': [
        // Ð¢ÐµÐ³Ð¸ Ð¿Ñ€ÐµÐ¿Ñ€Ð¾Ñ†ÐµÑÑÐ¾Ñ€Ð° Ð²Ð¸Ð´Ð° &ÐšÐ»Ð¸ÐµÐ½Ñ‚, &Ð¡ÐµÑ€Ð²ÐµÑ€, ...
        ...
        // Ð˜Ð½ÑÑ‚Ñ€ÑƒÐºÑ†Ð¸Ð¸ Ð¿Ñ€ÐµÐ¿Ñ€Ð¾Ñ†ÐµÑÑÐ¾Ñ€Ð° Ð²Ð¸Ð´Ð°:
        // #Ð•ÑÐ»Ð¸ Ð¡ÐµÑ€Ð²ÐµÑ€ Ð¢Ð¾Ð³Ð´Ð°
        // ...
        // #ÐšÐ¾Ð½ÐµÑ†Ð•ÑÐ»Ð¸
...
Prism.languages.julia = {
    ...
    'constant': /\b(?:(?:NaN|Inf)(?:16|32|64)?|im|pi)\b|[Ï€â„¯]/
};
